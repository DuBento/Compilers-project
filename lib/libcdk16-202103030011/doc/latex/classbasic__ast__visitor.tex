...
This class is only for compiling the package\+: it will not be installed. Specific compilers are supposed to define their own, with the SAME NAME, but defining ALL processing functions corresponding to their specific problem. 
